class Dizionario:
    def __init__(self) -> None:
        ...
        self.tooltips = {
            ...
            "reset":                "Resetta la tavolozza e arresta\nla renderizzazione in corso.",
            ...
            "round_label_x":        "Arrotondamento alla n-esima cifra\ndecimale X. Applicato su tutti gli\narrotondamenti nella sezione plots.",
            "subdivisions_x":       "Numero di linee presenti nella griglia del plot X.\nAttenzione: numero settori = n - 1",
            "round_label_y":        "Arrotondamento alla n-esima cifra\ndecimale Y. Applicato su tutti gli\narrotondamenti nella sezione plots.",
            "subdivisions_y":       "Numero di linee presenti nella griglia del plot Y.\nAttenzione: numero settori = n - 1",
            ...
            "x_foto":               "Risoluzione X dell'immagine salvata.",    
            "y_foto":               "Risoluzione Y dell'immagine salvata.",    
            "DPI":                  "DPI dell'immagine salvata.",
